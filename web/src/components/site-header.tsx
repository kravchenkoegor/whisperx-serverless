  ...
  return (
    <header className="border-b border-line bg-surface">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center gap-x-4 gap-y-1 px-4 py-2">
        <Link href={variant === "app" ? "/" : "/demo"} className="mr-2 inline-flex min-h-11 items-center font-semibold tracking-tight">
          Whisper control panel
        </Link>
        <nav aria-label="Main" className="flex flex-1 flex-wrap items-center gap-2">
          {variant === "app" ? (
            <>
